...
import kotlinx.android.synthetic.main.activity_update_profile_user.addressProfile
import kotlinx.android.synthetic.main.activity_update_profile_user.emailProfile
import kotlinx.android.synthetic.main.activity_update_profile_user.imgProfile1
import kotlinx.android.synthetic.main.activity_update_profile_user.nameProfile
import kotlinx.android.synthetic.main.activity_update_profile_user.phoneProfile
import kotlinx.android.synthetic.main.activity_update_profile_user.updateProfile
import java.util.*

class UpdateProfileUser : AppCompatActivity() , IPickResult {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateProfile.setOnClickListener {
            ...
            updateProfile(name.toString(),phone.toString(),email.toString(),address.toString(),path.toString())
